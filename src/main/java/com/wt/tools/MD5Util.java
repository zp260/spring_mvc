...
public class MD5Util {
     ...
     * 提供一个MD5多次加密方法
     */
    public static String encode(String origString, int times) {
        String md5 = encode(origString);
    ...
    public static boolean verifyPassword(String inputStr, String MD5Code) {
        return encode(inputStr).equals(MD5Code);
    }
    /**
     * 多次加密时的密码验证方法
     */
    public static boolean verifyPassword(String inputStr, String MD5Code, int times) {
        return encode(inputStr, times).equals(MD5Code);
    }
}
